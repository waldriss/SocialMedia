...
const PostInfosContainer = ({
  ...
  return isDeletingPost||isSuccess ? (
    <div className="flex w-full h-screen items-center">
      <LoadingSvg className="h-44 w-44 mb-20" />
    </div>
  ) : (
    <>
      ...
      <section className="  w-full flex-col items-center xl:h-[664px] bg-[#0d0d12] mt-10 rounded-3xl xl:flex-row flex xl:items-stretch overflow-hidden border-solid border border-1px border-borderPrimary">
...
export default PostInfosContainer;
